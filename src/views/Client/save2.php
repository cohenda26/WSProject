                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-6">
                                            <div class="list-group" id="list-etage" role="tablist">
                                                <a class="list-group-item list-group-item-action active" href="#list-etage" id="list-rdc-list"           role="tab"  data-toggle="collapse" aria-controls="Rdc">Au Rez de chaussé</a>
                                                <a class="list-group-item list-group-item-action "       href="#list-etage" id="list-premier-list"       role="tab"  data-toggle="collapse" aria-controls="premiereEtage">Au 1er étage</a>
                                                <a class="list-group-item list-group-item-action "       href="#list-etage" id="list-intermediaire-list" role="tab"  data-toggle="collapse" aria-controls="etageInter">En étage intermédiaire</a>
                                                <a class="list-group-item list-group-item-action "       href="#list-etage" id="list-dernier-list"       role="tab"  data-toggle="collapse" aria-controls="dernierEtage">Au dernier étage</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
