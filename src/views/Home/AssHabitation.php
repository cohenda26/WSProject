    ...
    <div class="container">
        <div class="row wrap-feature-26">
            <div class="col-md-6 align-self-center">
                <div class="max-box">
                    <h2 class="title m-t-20"> Contrats d’assurance habitation </h2>
                    <p class="m-t-30"> Une assurance habitation est une assurance destinée aux habitations de particulier et leurs annexes. Son objet principal est de couvrir les locaux, leur contenu et la responsabilité civile de ses occupants.
Pour les contrats d’assurance habitation on parle de contrat MRH « multirisques habitation » (pour les locaux de professionnel on parle de multirisque professionnel).
                    ...
                    <a class="linking" href="<?=HOST?>home/demanderDevisHabitation">Demander un devis <i class="ti-arrow-right"></i></a>
                </div>
            </div>
