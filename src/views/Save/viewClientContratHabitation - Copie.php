            ...
            <div class="card card-outline-info col-12">
                ...
                <div class="card-body">
                    <form class="form-control form-control-sm">
                        <!-- DEBUT CARD pour le contenu de la saisie -->
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title">Renseignements sur le logement</h3>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9 btn-group" role="group" aria-label="type appartement" id="typeAppartement">
                                        ...
                                        <button class="btn btn-sm btn-secondary" aria-expanded="true" 
                                                aria-controls="collapseMaison" type="button" 
                                                data-target="#collapseMaison" data-toggle="collapse">Maison</button>
                                    </div>
                                </div>

                                <div class="collapse" id="collapseAppartement">
                                    <div class="form-group row">
                                        <div class="col-3"> </div>
                        ...
                        <!-- FIN CARD pour le contenu de la saisie -->

                        <!-- DEBUT CARD pour les informations sur le logement -->
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title">Informations sur le logement</h3>
                        ...
                        <!-- FIN CARD pour les informations sur le logement -->

                        <!-- DEBUT CARD pour les définitions du besoin -->
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title">Mes besoins</h3>
                        ...
                        <!-- FIN CARD pour les définitions du besoin -->
                        ...
                        <a href="#" class="btn btn-inverse">envoyer</a>
                    </form>
                </div>
            </div>
        </div>
